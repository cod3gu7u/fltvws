        ...
        'rows' => [
            [
                'attributes' => [
                    ...
                    'expense_date'=>['type'=>Form::INPUT_WIDGET, 
...
$this->registerJs("
    $('#expense-transaction_amount, #expense-exchange_rate').change(function(){
        var trnx_amt = $('#expense-transaction_amount').val(),
            exchange_rate = $('#expense-exchange_rate').val(),
            total_amt = 0;
            trnx_amt = trnx_amt - 0; // convert to int
            exchange_rate = exchange_rate - 0; // convert to int
            total_amt = trnx_amt * exchange_rate;
            $('#expense-total_amount').val(total_amt.toFixed(2));
    });
");
?>